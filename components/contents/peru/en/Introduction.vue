<template>
  <div>
    ...
    <p>
      With per capita emissions of 2.0 tonnes, Peruvian CO<sub>2</sub> emissions are below both the high average level of 5 tonnes and the regional average for Latin America of 3.1 tonnes per capita.
    </p>
    <p>
