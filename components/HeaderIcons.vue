  ...
  <div :class="[!country ? 'px-6 sm:px-10 md:px-20 pt-10 lg:pt-20' : '']" class="mb-10 lg:absolute lg:w-full lg:-mt-104 lg:left-0 lg:right-0">
    <div v-if="country" class="mb-4 flex flex-row flex-wrap items-center">
      <div class="pulse-parent group flex sm:flex-col items-center w-full sm:w-1/2 lg:w-1/4">
        ...
        <span class="group-hover:scale-100 lg:scale-0 transition-all transition-100 ml-2 text-sm sm:ml-0 sm:mt-2 px-6 py-2 bg-gray-300 lg:bg-white rounded-full shadow-md">{{ $t('header.elevationCapital') }} <strong><span v-html="iconData.elevation"></span> m</strong></span>
      </div>
      <div class="pulse-parent mt-4 sm:mt-0 group flex sm:flex-col items-center w-full sm:w-1/2 lg:w-1/4">
        ...
        <span class="group-hover:scale-100 lg:scale-0 transition-all transition-100 ml-2 text-sm sm:ml-0 sm:mt-2 px-6 py-2 bg-gray-300 lg:bg-white rounded-full shadow-md">{{ $t('header.gdp') }} <strong><span v-html="iconData.gdp"></span> USD</strong></span>
      </div>
      <div class="pulse-parent mt-4 lg:mt-0 group flex sm:flex-col items-center w-full sm:w-1/2 lg:w-1/4">
        ...
        <span class="group-hover:scale-100 lg:scale-0 transition-all transition-100 ml-2 text-sm sm:ml-0 sm:mt-2 px-6 py-2 bg-gray-300 lg:bg-white rounded-full shadow-md">{{ $t('header.population') }} <strong v-html="iconData.inhabitants"></strong></span>
      </div>
      <div class="pulse-parent mt-4 lg:mt-0 group flex sm:flex-col items-center w-full sm:w-1/2 lg:w-1/4">
        <div :class="'text-' + color + '-500'" class="pulse-child bg-gray-300 lg:bg-white h-12 w-12 sm:h-16 sm:w-16 lg:h-20 lg:w-20 rounded-full flex items-center content-center justify-center shadow-md">
        ...
        <span class="group-hover:scale-100 lg:scale-0 transition-all transition-100 ml-2 text-sm sm:ml-0 sm:mt-2 px-6 py-2 bg-gray-300 lg:bg-white rounded-full shadow-md">{{ $t('header.area') }} <strong><span v-html="iconData.area"></span> km<sup>2</sup></strong></span>
      </div>
    </div>
    <div v-if="!country" class="mb-4 flex flex-row flex-wrap items-center">
      <div class="pulse-parent sm:mt-0 group flex sm:flex-col items-center w-full sm:w-1/2 lg:w-1/4">
        ...
        <span class="group-hover:scale-100 lg:scale-0 transition-all transition-100 ml-2 text-sm sm:ml-0 sm:mt-2 px-6 py-2 bg-white rounded-full shadow-md">{{ $t('header.flightRoute') }} <strong>35&thinsp;500 km</strong></span>
      </div>
      <div class="pulse-parent mt-4 lg:mt-0 group flex sm:flex-col items-center w-full sm:w-1/2 lg:w-1/4">
        <div :class="'text-' + color + '-500'" class="pulse-child bg-white h-12 w-12 sm:h-16 sm:w-16 lg:h-20 lg:w-20 rounded-full flex items-center content-center justify-center shadow-md">
      ...
      <div class="pulse-parent mt-4 lg:mt-0 group flex sm:flex-col items-center w-full sm:w-1/2 lg:w-1/4">
        ...
        <span class="group-hover:scale-100 lg:scale-0 transition-all transition-100 ml-2 text-sm sm:ml-0 sm:mt-2 px-6 py-2 bg-white rounded-full shadow-md">{{ $t('header.interviewMins') }} <strong>5&thinsp;754</strong></span>
      </div>
      <div class="pulse-parent mt-4 group flex sm:flex-col items-center w-full sm:w-1/2 lg:w-1/4">
        <div :class="'text-' + color + '-500'" class="pulse-child bg-white h-12 w-12 sm:h-16 sm:w-16 lg:h-20 lg:w-20 rounded-full flex items-center content-center justify-center shadow-md">
          <icon-base :twClass="['w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12']" icon-name="altitude"><icon-altitude /></icon-base>
        </div>
        <span class="group-hover:scale-100 lg:scale-0 transition-all transition-100 ml-2 text-sm sm:ml-0 sm:mt-2 px-6 py-2 bg-white rounded-full shadow-md">{{ $t('header.metersAltitude') }} <strong>11&thinsp;434</strong></span>
      </div>
    </div>
  </div>
</template>
